...
class Masternodes:
    ...
    async def mninfo(self, ctx):
        ...
        embed.set_author(name='QUAD Masternode Information', icon_url="https://i0.wp.com/quadrivaecoin.com/wp-content/uploads/2018/07/quadrivae-128-1.png")
        ...
        embed.add_field(name="Daily Income", value="{0:.4f} QUAD".format(daily_reward))
        embed.add_field(name="Monthly Income", value="{0:.4f} QUAD".format(monthly_reward))
        embed.add_field(name="Yearly Income", value="{0:.4f} QUAD".format(yearly_reward))
