...
class Mining:
    ...
    async def mining(self, ctx):
        ...
        embed.set_author(name='QUAD Mining Information', icon_url="https://i0.wp.com/quadrivaecoin.com/wp-content/uploads/2018/07/quadrivae-128-1.png")
        ...
        try:
            async with ClientSession() as session:
                async with session.get("http://api.bsod.pw/api/currencies", headers=headers) as response:
                    ...
                    miningData = json.loads(responseRaw)["QUAD"]
                    ...
                    embed.set_footer(text="ccminer.exe -a lyra2v2 -o stratum+tcp://pool.bsod.pw:1982 -u <Wallet Address>.<Rigname> -p c=QUAD -R 5")
                    await self.bot.say(embed=embed)
