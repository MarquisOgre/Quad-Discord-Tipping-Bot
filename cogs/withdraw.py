...
class Withdraw:
    ...
    async def withdraw(self, ctx, address: str, amount: float):
        """Withdraw coins from your account to any Quadrivae address"""
        ...
        if txid is None:
            ...
            await self.bot.say("{} **Withdrew {} QUAD! <:quad:469787831137599488>**{} ".format(ctx.message.author.mention, str(amount), txid))
